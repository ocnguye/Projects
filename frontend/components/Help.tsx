    ...
    return (
        <div className="bg-transparent flex flex-col items-center justify-center px-4 py-8 min-h-screen">
            ...
            <div className="w-3/4 flex flex-col gap-4">
                {rows.map((row, index) => (
                    <div key={index} className="bg-yellow-300 rounded-xl shadow-md overflow-hidden">
                        <div
                            className="cursor-pointer p-4 flex justify-between items-center transition duration-300 ease-in-out"
                            onClick={() => toggleRow(index)}
                        >
                            <h3 className="yellow">{row.title}</h3>
                        ...
                        >
                            <div className="p-4 text-green-900 bg-white">
                                ...
                                <p className="pt-6">{row.content.question1}</p>
                                <p className="pt-2">{row.content.answer1}</p>
                                <p className="pt-6">{row.content.question2}</p>
