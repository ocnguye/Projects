        ...
        <div className="bg-[#DFF0D8] flex justify-evenly items-center h-screen w-screen px-10 py-4 space-x-8">
            ...
            <div className="bg-transparent flex flex-col justify-evenly h-full w-1/2 px-15 space-y-4">
                ...
                <div className="bg-[#C3F49D] rounded-xl flex flex-col h-2/3 w-full">
                    ...
                    <strong className="text-green-800 text-3xl font-bold px-4 py-2 pt-4"> About The Pookies </strong> 
...
The above image shows (from left to right) Jonastin, Oansha, Jasaid, Auson, Sashathan, Zenanh, and Generation 1 Optimus Prime.</p>
            ...
            <div className="bg-transparent flex flex-col justify-evenly h-full w-1/2 px-15 space-y-4">
                <div className="bg-[#C3F49D] rounded-xl flex flex-col h-2/3 w-full">
                    <h1 className="text-green-800 text-3xl text-right font-bold px-4 py-2 pt-4"> Angel Trading Co. </h1> 
